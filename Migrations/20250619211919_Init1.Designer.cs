...
namespace CourseStudent.Migrations
{
    ...
    [Migration("20250619211919_Init1")]
    partial class Init1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseStudent.Models.Backpack", b =>
                {
            ...
            modelBuilder.Entity("CourseStudent.Models.Character", b =>
                {
                    b.Property<int>("CharacterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourseStudent.Models.CharacterTitle", b =>
                {
                    b.Property<int>("CharacterId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourseStudent.Models.Item", b =>
                {
                    b.Property<int>("ItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourseStudent.Models.Title", b =>
                {
                    b.Property<int>("TitleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourseStudent.Models.Backpack", b =>
                {
                    b.HasOne("CourseStudent.Models.Character", "Character")
                        .WithMany("BackpackItems")
                        .HasForeignKey("CharacterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CourseStudent.Models.Item", "Item")
                        .WithMany("Backpacks")
            ...
            modelBuilder.Entity("CourseStudent.Models.CharacterTitle", b =>
                {
                    ...
                    b.HasOne("CourseStudent.Models.Title", "Title")
